...
export const passwordUpdateRequest = body =>
  invoke({
    endpoint: `/api/oauth/tokens/actions/change_password`,
    method: "POST",
    types: [
...
export const newPasswordRequest = password =>
  invoke(
    {
      endpoint: `/api/oauth/users/actions/update_password`,
      method: "POST",
      types: [
        "auth/PASSWORD_UPDATE_REQUEST",
        "auth/PASSWORD_UPDATE_SUCCESS",
...
export const updatePassword = (id, body) =>
  invoke({
    endpoint: `/api/users/${id}/actions/change_password`,
    method: "PATCH",
    types: [
...
export const authorize = ({ clientId, scope, redirectUri }) =>
  invoke(
    {
      endpoint: `/api/oauth/apps/authorize`,
      method: "POST",
      types: [
