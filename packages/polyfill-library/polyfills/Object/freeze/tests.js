...
ifHasES6ObjectFreeze(
  "Should not throw a TypeError if called with undefined",
  function() {
    var obj = undefined;
...
ifHasES6ObjectFreeze(
  "Should not throw a TypeError if called with null",
  function() {
    var obj = null;
    proclaim.doesNotThrow(function() {
      Object.freeze(obj);
...
ifHasES6ObjectFreeze(
  "Should not throw a TypeError if called with a boolean primitive",
  function() {
    var obj = true;
    proclaim.doesNotThrow(function() {
      Object.freeze(obj);
...
ifHasES6ObjectFreeze(
  "Should not throw a TypeError if called with a number primitive",
  function() {
    var obj = 100;
    proclaim.doesNotThrow(function() {
      Object.freeze(obj);
...
ifHasES6ObjectFreeze(
  "Should not throw a TypeError if called with an array primitive",
  function() {
    var obj = [];
    proclaim.doesNotThrow(function() {
      Object.freeze(obj);
...
ifHasES6ObjectFreeze(
  "Should not throw a TypeError if called with a string primitive",
  function() {
    var obj = "";
    proclaim.doesNotThrow(function() {
      Object.freeze(obj);
