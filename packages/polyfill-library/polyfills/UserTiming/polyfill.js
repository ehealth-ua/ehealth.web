  ...
  if (
    ...
    for (i = 0; i < methods.length; i++) {
      for (j = 0; j < prefixes.length; j++) {
        ...
        methodTest =
          prefixes[j] +
          methods[i].substr(0, 1).toUpperCase() +
          methods[i].substr(1);
    ...
    clearEntriesFromPerformanceTimeline = function(entryType, name) {
      ...
      while (i < performanceTimeline.length) {
        ...
        if (
          ...
          performanceTimeline[i].name !== name
        ) {
          // unmatched name
          i++;
          continue;
    ...
    if (
      typeof window.performance.getEntries !== "function" ||
      hasNativeGetEntriesButNotUserTiming
    ) {
      ...
      window.performance.getEntries = function() {
        ...
        if (hasNativeGetEntriesButNotUserTiming && origGetEntries) {
          ...
          Array.prototype.push.apply(
            entries,
            origGetEntries.call(window.performance)
          );
      ...
      window.performance.getEntriesByName = function(name, entryType) {
        if (entryType && entryType !== "mark" && entryType !== "measure") {
          if (hasNativeGetEntriesButNotUserTiming && origGetEntriesByName) {
            // native version exists, forward
            return origGetEntriesByName.call(
              window.performance,
              name,
              entryType
            );
        ...
        if (hasNativeGetEntriesButNotUserTiming && origGetEntriesByName) {
          ...
          Array.prototype.push.apply(
            entries,
            origGetEntriesByName.call(window.performance, name, entryType)
          );
  ...
  if (typeof window.performance.mark !== "function") {
    ...
    if (typeof window.performance.mark !== "function") {
      ...
      window.performance.mark = function(markName) {
        ...
        if (
          window.performance.timing &&
          markName in window.performance.timing
        ) {
    ...
    if (typeof window.performance.measure !== "function") {
      ...
      window.performance.measure = function(measureName, startMark, endMark) {
        ...
        if (
          window.performance.timing &&
          startMark in window.performance.timing
        ) {
          // mark cannot have a timing of 0
          if (
            startMark !== "navigationStart" &&
            window.performance.timing[startMark] === 0
          ) {
          ...
          startMarkTime =
            window.performance.timing[startMark] -
            window.performance.timing.navigationStart;
        ...
        if (endMark) {
          ...
          if (
            window.performance.timing &&
            endMark in window.performance.timing
          ) {
            // mark cannot have a timing of 0
            if (
              endMark !== "navigationStart" &&
              window.performance.timing[endMark] === 0
            ) {
            ...
            // time is the offset of this mark to navigationStart's time
            endMarkTime =
              window.performance.timing[endMark] -
              window.performance.timing.navigationStart;
