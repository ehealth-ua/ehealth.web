  ...
  date: {
    ...
    calendars: {
      ...
      gregory: {
        ...
        eras: {
          narrow: ["pr. Kr.", "po Kr.", "pr. m. e.", "mūsų eroje"],
          short: ["pr. Kr.", "po Kr.", "pr. m. e.", "mūsų eroje"],
          long: ["prieš Kristų", "po Kristaus", "prieš mūsų erą", "mūsų eroje"]
        },
        dayPeriods: { am: "priešpiet", pm: "popiet" }
      },
      hebrew: {
      ...
      roc: {
        ...
        eras: {
          narrow: ["Prieš R.O.C.", "R.O.C."],
          short: ["Prieš R.O.C.", "R.O.C."],
          long: ["Prieš R.O.C.", "R.O.C."]
        },
        dayPeriods: { am: "priešpiet", pm: "popiet" }
      }
    }
