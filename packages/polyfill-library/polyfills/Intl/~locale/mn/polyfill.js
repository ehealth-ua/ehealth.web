IntlPolyfill.__addLocaleData({
  ...
  date: {
    ...
    formats: {
      ...
      dateFormats: {
        yMMMMEEEEd: "EEEE, y 'оны' MM 'сарын' d",
        yMMMMd: "y 'оны' MM 'сарын' d",
        yMMMd: "y MMM d",
        yMd: "y-MM-dd"
      },
      timeFormats: {
    ...
    calendars: {
      ...
      gregory: {
        ...
        eras: {
          narrow: ["МЭӨ", "МЭ", "НТӨ", "НТ"],
          short: ["м.э.ө", "м.э.", "НТӨ", "НТ"],
          long: ["манай эриний өмнөх", "манай эриний", "НТӨ", "НТ"]
        },
        dayPeriods: { am: "ҮӨ", pm: "ҮХ" }
      },
      hebrew: {
