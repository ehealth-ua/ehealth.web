  ...
  date: {
    ...
    calendars: {
      ...
      gregory: {
        ...
        eras: {
          narrow: ["pr.n.e.", "AD", "pr. n. e.", "n.e."],
          short: ["pr. Kr.", "p. Kr.", "pr. n. e.", "n.e."],
          long: ["prije Krista", "poslije Krista", "pr. n. e.", "n.e."]
        },
        dayPeriods: { am: "AM", pm: "PM" }
      },
      hebrew: {
      ...
      roc: {
        ...
        eras: {
          narrow: ["prije R.O.C.", "R.O.C."],
          short: ["prije R.O.C.", "R.O.C."],
          long: ["prije R.O.C.", "R.O.C."]
        },
        dayPeriods: { am: "AM", pm: "PM" }
      }
    }
