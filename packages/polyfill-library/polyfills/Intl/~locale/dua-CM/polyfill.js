    ...
    calendars: {
      buddhist: {
        ...
        days: {
          ...
          long: ["éti", "mɔ́sú", "kwasú", "mukɔ́sú", "ŋgisú", "ɗónɛsú", "esaɓasú"]
        },
        eras: { narrow: ["BE"], short: ["BE"], long: ["BE"] },
        dayPeriods: { am: "idiɓa", pm: "ebyámu" }
      },
      chinese: {
        months: {
          narrow: [
      ...
      gregory: {
        ...
        eras: {
          narrow: ["ɓ.Ys", "mb.Ys", "BCE", "CE"],
          short: ["ɓ.Ys", "mb.Ys", "BCE", "CE"],
          long: ["ɓoso ɓwá yáɓe lá", "mbúsa kwédi a Yés", "BCE", "CE"]
        },
        dayPeriods: { am: "idiɓa", pm: "ebyámu" }
      },
      hebrew: {
