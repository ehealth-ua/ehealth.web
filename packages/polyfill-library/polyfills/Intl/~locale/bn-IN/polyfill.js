    ...
    calendars: {
      buddhist: {
        ...
        days: {
          ...
          short: ["রবি", "সোম", "মঙ্গল", "বুধ", "বৃহস্পতি", "শুক্র", "শনি"],
          long: [
            "রবিবার",
            "সোমবার",
            "মঙ্গলবার",
      ...
      gregory: {
        ...
        eras: {
          ...
          long: ["খ্রিস্টপূর্ব", "খৃষ্টাব্দ", "খ্রিষ্টপূর্বাব্দ", "খ্রিষ্টাব্দ"]
        },
        dayPeriods: { am: "AM", pm: "অপরাহ্ণ" }
      },
      hebrew: {
      ...
      indian: {
        ...
        eras: { narrow: ["সাল"], short: ["সাল"], long: ["সাল"] },
        dayPeriods: { am: "AM", pm: "অপরাহ্ণ" }
      },
      islamic: {
        months: {
        ...
        eras: { narrow: ["যুগ"], short: ["যুগ"], long: ["যুগ"] },
        dayPeriods: { am: "AM", pm: "অপরাহ্ণ" }
      },
      islamicc: {
        months: {
