  ...
  date: {
    ...
    calendars: {
      buddhist: {
        ...
        dayPeriods: { am: "таңкы", pm: "түштөн кийинки" }
      },
      chinese: {
        months: {
          narrow: [
      ...
      gregory: {
        ...
        eras: {
          narrow: ["б.з.ч.", "б.з.", "BCE", "CE"],
          short: ["б.з.ч.", "б.з.", "BCE", "CE"],
          long: ["биздин заманга чейин", "биздин заман", "BCE", "CE"]
        },
        dayPeriods: { am: "таңкы", pm: "түштөн кийинки" }
      },
      hebrew: {
