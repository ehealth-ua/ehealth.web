  ...
  date: {
    ...
    calendars: {
      buddhist: {
        ...
        eras: { narrow: ["БЕ"], short: ["БЕ"], long: ["БЕ"] },
        dayPeriods: { am: "пре подне", pm: "поподне" }
      },
      chinese: {
        months: {
          narrow: [
      ...
      gregory: {
        ...
        eras: {
          narrow: ["п.н.е.", "н.е.", "BCE", "CE"],
          short: ["п. н. е.", "н. е.", "BCE", "CE"],
          long: ["Пре нове ере", "Нове ере", "BCE", "CE"]
        },
        dayPeriods: { am: "пре подне", pm: "поподне" }
      },
      hebrew: {
      ...
      indian: {
        ...
        eras: { narrow: ["САКА"], short: ["САКА"], long: ["САКА"] },
        dayPeriods: { am: "пре подне", pm: "поподне" }
      },
      islamic: {
        months: {
        ...
        eras: { narrow: ["АХ"], short: ["АХ"], long: ["АХ"] },
        dayPeriods: { am: "пре подне", pm: "поподне" }
      },
      islamicc: {
        months: {
