  ...
  date: {
    ...
    calendars: {
      buddhist: {
        ...
        days: {
          narrow: ["Կ", "Ե", "Ե", "Չ", "Հ", "Ու", "Շ"],
          short: ["կիր", "երկ", "երք", "չրք", "հնգ", "ուր", "շբթ"],
          long: [
            "կիրակի",
            "երկուշաբթի",
            "երեքշաբթի",
      ...
      gregory: {
        ...
        eras: {
          narrow: ["մ.թ.ա.", "մ.թ.", "մ.թ.ա", "CE"],
          short: ["մ.թ.ա.", "մ.թ.", "մ.թ.ա", "CE"],
          long: ["մ.թ.ա.", "մ.թ.", "մեր թվարկությունից առաջ", "մեր թվարկության"]
        },
        dayPeriods: { am: "AM", pm: "PM" }
      },
      hebrew: {
