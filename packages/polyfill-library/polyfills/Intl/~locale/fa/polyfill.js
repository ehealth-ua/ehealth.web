  ...
  date: {
    ...
    calendars: {
      buddhist: {
        ...
        dayPeriods: { am: "قبل‌ازظهر", pm: "بعدازظهر" }
      },
      chinese: {
        months: {
          narrow: [
      ...
      gregory: {
        ...
        eras: {
          narrow: ["ق", "م", "ق.د.م", "د.م."],
          short: ["ق.م.", "م.", "ق.د.م", "د.م."],
          long: ["قبل از میلاد", "میلادی", "قبل از دوران مشترک", "دوران مشترک"]
        },
        dayPeriods: { am: "قبل‌ازظهر", pm: "بعدازظهر" }
      },
      hebrew: {
      ...
      islamic: {
        ...
        eras: { narrow: ["ه‍.ق."], short: ["ه‍.ق."], long: ["هجری قمری"] },
        dayPeriods: { am: "قبل‌ازظهر", pm: "بعدازظهر" }
      },
      islamicc: {
        months: {
      ...
      persian: {
        ...
        eras: { narrow: ["ه‍.ش."], short: ["ه‍.ش."], long: ["هجری شمسی"] },
        dayPeriods: { am: "قبل‌ازظهر", pm: "بعدازظهر" }
      },
      roc: {
        months: {
