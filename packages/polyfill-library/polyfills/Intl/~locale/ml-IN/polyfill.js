  ...
  date: {
    ...
    calendars: {
      buddhist: {
        ...
        days: {
          narrow: ["ഞ", "തി", "ചൊ", "ബു", "വ്യാ", "വെ", "ശ"],
          short: ["ഞായർ", "തിങ്കൾ", "ചൊവ്വ", "ബുധൻ", "വ്യാഴം", "വെള്ളി", "ശനി"],
          long: [
            "ഞായറാഴ്‌ച",
            "തിങ്കളാഴ്‌ച",
            "ചൊവ്വാഴ്ച",
      ...
      gregory: {
        ...
        eras: {
          narrow: ["ക്രി.മു.", "എഡി", "ബിസിഇ", "സിഇ"],
          short: ["ക്രി.മു.", "എഡി", "ബിസിഇ", "സിഇ"],
          long: ["ക്രിസ്‌തുവിന് മുമ്പ്", "ആന്നോ ഡൊമിനി", "ബി.സി.ഇ.", "സി.ഇ."]
        },
        dayPeriods: { am: "AM", pm: "PM" }
      },
      hebrew: {
      ...
      indian: {
        ...
        eras: { narrow: ["ശക"], short: ["ശക"], long: ["ശക"] },
        dayPeriods: { am: "AM", pm: "PM" }
      },
      islamic: {
        months: {
        ...
        eras: { narrow: ["ഹിജറ"], short: ["ഹിജറ"], long: ["ഹിജറ"] },
        dayPeriods: { am: "AM", pm: "PM" }
      },
      islamicc: {
        months: {
