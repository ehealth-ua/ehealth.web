    ...
    calendars: {
      buddhist: {
        ...
        days: {
          ...
          long: ["Sul", "Lun", "Meurzh", "Mercʼher", "Yaou", "Gwener", "Sadorn"]
        },
        eras: { narrow: ["BE"], short: ["BE"], long: ["BE"] },
        dayPeriods: { am: "A.M.", pm: "G.M." }
      },
      chinese: {
        months: {
          narrow: [
      ...
      gregory: {
        ...
        eras: {
          narrow: ["a-raok J.K.", "goude J.K.", "BCE", "CE"],
          short: ["a-raok J.K.", "goude J.K.", "BCE", "CE"],
          long: ["a-raok Jezuz-Krist", "goude Jezuz-Krist", "BCE", "CE"]
        },
        dayPeriods: { am: "A.M.", pm: "G.M." }
      },
      hebrew: {
      ...
      roc: {
        ...
        eras: {
          narrow: ["a-raok R.S.", "R.S."],
          short: ["a-raok R.S.", "R.S."],
          long: ["a-raok Republik Sina", "Republik Sina"]
        },
        dayPeriods: { am: "A.M.", pm: "G.M." }
      }
    }
