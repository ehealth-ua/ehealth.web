    ...
    calendars: {
      buddhist: {
        ...
        days: {
          ...
          short: ["ਐਤ", "ਸੋਮ", "ਮੰਗਲ", "ਬੁੱਧ", "ਵੀਰ", "ਸ਼ੁੱਕਰ", "ਸ਼ਨਿੱਚਰ"],
          long: [
            "ਐਤਵਾਰ",
            "ਸੋਮਵਾਰ",
            "ਮੰਗਲਵਾਰ",
      ...
      gregory: {
        ...
        eras: {
          narrow: ["ਈ. ਪੂ.", "ਸੰਨ", "ਈ. ਪੂ. ਸੰ.", "ਈ. ਸੰ."],
          short: ["ਈ. ਪੂ.", "ਸੰਨ", "ਈ. ਪੂ. ਸੰ.", "ਈ. ਸੰ."],
          long: ["ਈਸਵੀ ਪੂਰਵ", "ਈਸਵੀ ਸੰਨ", "ਈਸਵੀ ਪੂਰਵ ਯੁੱਗ", "ਈਸਵੀ ਯੁੱਗ"]
        },
        dayPeriods: { am: "ਪੂ.ਦੁ.", pm: "ਬਾ.ਦੁ." }
      },
      hebrew: {
      ...
      indian: {
        ...
        eras: { narrow: ["ਸਾਕਾ"], short: ["ਸਾਕਾ"], long: ["ਸਾਕਾ"] },
        dayPeriods: { am: "ਪੂ.ਦੁ.", pm: "ਬਾ.ਦੁ." }
      },
      islamic: {
        months: {
