    ...
    calendars: {
      buddhist: {
        ...
        days: {
          ...
          short: ["нед.", "пон.", "вт.", "сре.", "чет.", "пет.", "саб."],
          long: [
            "недела",
            "понеделник",
            "вторник",
        ...
        dayPeriods: { am: "претпладне", pm: "попладне" }
      },
      chinese: {
        months: {
          narrow: [
      ...
      gregory: {
        ...
        eras: {
          narrow: ["пр.н.е.", "н.е.", "пр. н.е.", "CE"],
          short: ["пр.н.е.", "н.е.", "пр. н.е.", "CE"],
          long: ["пред нашата ера", "од нашата ера", "пр. н.е.", "CE"]
        },
        dayPeriods: { am: "претпладне", pm: "попладне" }
      },
      hebrew: {
