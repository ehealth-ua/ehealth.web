IntlPolyfill.__addLocaleData({
  ...
  date: {
    ...
    formats: {
      ...
      dateFormats: {
        yMMMMEEEEd: "EEEE, སྤྱི་ལོ་y MMMM ཚེས་dd",
        yMMMMd: "སྤྱི་ལོ་y MMMM ཚེས་ dd",
        yMMMd: "སྤྱི་ལོ་y ཟླ་MMM ཚེས་dd",
        yMd: "y-MM-dd"
      },
      timeFormats: {
        hmmsszzzz: "ཆུ་ཚོད་ h སྐར་མ་ mm:ss a zzzz",
        hmsz: "ཆུ་ཚོད་ h སྐར་མ་ mm:ss a z",
        hms: "ཆུ་ཚོད་h:mm:ss a",
        hm: "ཆུ་ཚོད་ h སྐར་མ་ mm a"
      }
    },
    calendars: {
      buddhist: {
        ...
        days: {
          narrow: ["ཟླ", "མིར", "ལྷག", "ཕུར", "སངྶ", "སྤེན", "ཉི"],
          short: ["ཟླ་", "མིར་", "ལྷག་", "ཕུར་", "སངས་", "སྤེན་", "ཉི་"],
          long: [
            "གཟའ་ཟླ་བ་",
            "གཟའ་མིག་དམར་",
            "གཟའ་ལྷག་པ་",
      ...
      roc: {
        ...
        eras: {
          narrow: ["Before R.O.C.", "R.O.C."],
          short: ["Before R.O.C.", "R.O.C."],
          long: ["Before R.O.C.", "R.O.C."]
        },
        dayPeriods: { am: "སྔ་ཆ་", pm: "ཕྱི་ཆ་" }
      }
    }
