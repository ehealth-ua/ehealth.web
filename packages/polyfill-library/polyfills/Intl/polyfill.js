!(function(e, r) {
  ...
  function t() {
    Ie(this, "length", { writable: !0, value: 0 }),
  ...
  function a(e) {
    ...
    return "object" === ("undefined" == typeof e ? "undefined" : Ne.typeof(e))
      ? e
      : Object(e);
  }
  function i(e) {
  ...
  function f(e) {
    ...
    (e = Ze.call(t, "-")),
      (r = e.match(lr)) &&
        r.length > 1 &&
        (r.sort(),
        (e = e.replace(RegExp("(?:" + lr.source + ")+", "i"), Ze.call(r, "")))),
    ...
    for (var n = a(e), i = s(n.length), o = 0; o < i; ) {
      ...
      if (c) {
        ...
        if (
          null === u ||
          ("string" != typeof u &&
            "object" !== ("undefined" == typeof u ? "undefined" : Ne.typeof(u)))
        )
          throw new TypeError("String or Object type expected");
        var m = String(u);
        if (!g(m))
          throw new RangeError(
            "'" + m + "' is not a structurally valid language tag"
          );
  ...
  function j(e, t, n) {
    ...
    if (
      ...
      ((n = new r(a(n))),
      (i = n.localeMatcher),
      void 0 !== i && ((i = String(i)), "lookup" !== i && "best fit" !== i))
    )
      throw new RangeError('matcher should be "lookup" or "best fit"');
    o = void 0 === i || "best fit" === i ? x(e, t) : w(e, t);
    for (var s in o)
      Me.call(o, s) &&
        Ie(o, s, { writable: !1, configurable: !1, value: o[s] });
  ...
  function D(e, r, t, n, a) {
    ...
    if (void 0 !== i) {
      if (
        ((i = "boolean" === t ? Boolean(i) : "string" === t ? String(i) : i),
  ...
  function F(e, i, o) {
    ...
    if (void 0 !== w && !v(w))
      throw new RangeError("'" + w + "' is not a valid currency code");
  ...
  function N(e, r) {
    ...
    !isNaN(r) && r < 0
      ...
      : (c = n["[[positivePattern]]"]);
    for (
      var u = new t(), g = c.indexOf("{", 0), f = 0, m = 0, v = c.length;
      g > -1 && g < v;
      ...
      if ("number" === h)
        if (isNaN(r)) {
          ...
          if (
            (x > 0
              ? ((b = y.substring(0, x)), (w = y.substring(x + 1, x.length)))
              : ((b = y), (w = void 0)),
            n["[[useGrouping]]"] === !0)
          ) {
            var j = s.group,
            ...
            for (; D.length; ) {
              var E = Be.call(D);
              Ge.call(u, { "[[type]]": "integer", "[[value]]": E }),
                D.length && Ge.call(u, { "[[type]]": "group", "[[value]]": j });
            }
          } else Ge.call(u, { "[[type]]": "integer", "[[value]]": b });
          if (void 0 !== w) {
            var L = s.decimal;
            Ge.call(u, { "[[type]]": "decimal", "[[value]]": L }),
              Ge.call(u, { "[[type]]": "fraction", "[[value]]": w });
          }
        } else {
          var P = s.infinity;
        ...
        "code" === n["[[currencyDisplay]]"]
          ...
          Ge.call(u, { "[[type]]": "currency", "[[value]]": R });
      } else {
  ...
  function _(r, t, n) {
    ...
    if (
      (o >= 0
        ...
        : o < 0 && (i = "0." + Ze.call(Array(-(o + 1) + 1), "0") + i),
      i.indexOf(".") >= 0 && n > t)
    ) {
  ...
  function R(e, r) {
    for (var t = { _: {} }, n = 0; n < br.length; n += 1)
  ...
  function C(e, r) {
    switch (e.charAt(0)) {
      ...
      case "E":
        return (
          (r.weekday = ["short", "short", "short", "long", "narrow", "short"][
            e.length - 1
          ]),
          "{weekday}"
        );
      ...
      case "c":
        return (
          (r.weekday = ["numeric", void 0, "short", "long", "narrow", "short"][
            e.length - 1
          ]),
          "{weekday}"
        );
      ...
      case "x":
        return (
          (r.timeZoneName = e.length < 4 ? "short" : "long"), "{timeZoneName}"
        );
    }
  }
  function G(e, r) {
  ...
  function K(e, a, i) {
    ...
    if (o["[[hour]]"])
      if (
        ((L = void 0 === L ? z.hour12 : L), (o["[[hour12]]"] = L), L === !0)
      ) {
        var P = z.hourNo0;
  ...
  function Q(e, r) {
    ...
    for (
      var i = a["[[locale]]"],
        o = new mr.NumberFormat([i], { useGrouping: !1 }),
      ...
      if (Dr.hasOwnProperty(y)) {
        ...
        Ge.call(u, { type: y, value: p });
      } else if ("ampm" === y) {
        var x = l["[[hour]]"];
        (p = U(d, h, "dayPeriods", x > 11 ? "pm" : "am", null)),
          Ge.call(u, { type: "dayPeriod", value: p });
      } else Ge.call(u, { type: "literal", value: c.substring(f, m + 1) });
      (g = m + 1), (f = c.indexOf("{", g));
    }
    return (
      m < c.length - 1 &&
        Ge.call(u, { type: "literal", value: c.substr(m + 1) }),
      u
    );
  }
  function ee(e, r) {
  ...
  function ne(e, r) {
    ...
    var t = void 0,
      ...
      a = r.split("-");
    for (
      a.length > 2 && 4 === a[1].length && Ge.call(n, a[0] + "-" + a[2]);
      (t = Be.call(n));
    ...
    Ie = Te
      ...
      : function(e, r, t) {
          "get" in t && e.__defineGetter__
            ...
            : (!Me.call(e, r) || "value" in t) && (e[r] = t.value);
        },
    Ae =
  ...
  Ie(mr, "NumberFormat", { configurable: !0, writable: !0, value: O }),
    Ie(mr.NumberFormat, "prototype", { writable: !1 }),
    ($e.NumberFormat = {
      "[[availableLocales]]": [],
    ...
    Ie(mr.NumberFormat.prototype, "format", { configurable: !0, get: E }),
  ...
  var hr = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g,
    ...
    jr = Re(null, { narrow: {}, short: {}, long: {} });
  Ie(mr, "DateTimeFormat", { configurable: !0, writable: !0, value: $ }),
    Ie($, "prototype", { writable: !1 });
  var Dr = {
  ...
  ($e.DateTimeFormat = {
    ...
    Ie(mr.DateTimeFormat.prototype, "format", { configurable: !0, get: V }),
  ...
  var zr = (mr.__localeSensitiveProtos = { Number: {}, Date: {} });
  if (
