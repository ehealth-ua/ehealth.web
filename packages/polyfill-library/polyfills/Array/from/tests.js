...
describe("returns an array with", function() {
  ...
  it("objects", function() {
    ...
    proclaim.deepEqual(Array.from({ 0: "a", 1: "b", 2: "c", length: 3 }), [
      "a",
      "b",
      "c"
    ]);
  ...
  describe("Iterable", function() {
    ...
    if ("Map" in window) {
      ...
      it("can convert from Map", function() {
        ...
        proclaim.deepEqual(Array.from(map, returnArgs), [
          [[1, 2], 0],
          [[3, 4], 1]
        ]);
      });
    ...
    if ("Set" in window) {
      ...
      it("can convert from Set", function() {
        ...
        proclaim.deepEqual(Array.from(set, returnArgs), [
          [1, 0],
          [2, 1],
          [3, 2],
          [4, 3],
      ...
      if (typeof set.values == "function") {
        ...
        if (typeof setIterator.next === "function") {
          it("can convert from set iterator", function() {
            proclaim.deepEqual(Array.from(setIterator), [
              1,
              2,
              3,
              4,
  ...
  it("mapping functions", function() {
    ...
    proclaim.deepEqual(Array.from(["a", "b", "c"], addElementAndIndex), [
      "a0",
      "b1",
      "c2"
    ]);
    proclaim.deepEqual(
      Array.from({ 0: "a", 1: "b", 3: "c" }, addElementAndIndex),
      []
    );
    proclaim.deepEqual(
      Array.from({ 0: "a", 1: "b", 2: "c", length: 3 }, addElementAndIndex),
      ["a0", "b1", "c2"]
    );
    proclaim.deepEqual(Array.from("abc", addElementAndIndex), [
      "a0",
      "b1",
      "c2"
    ]);
