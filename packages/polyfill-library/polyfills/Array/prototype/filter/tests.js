...
it("correctly filters an array", function() {
  proclaim.deepEqual(Array.prototype.filter.call(["foo", "bar"], stringsOnly), [
    "foo",
    "bar"
  ]);
  proclaim.deepEqual(
    Array.prototype.filter.call([7, "foo", 42, "bar"], stringsOnly),
    ["foo", "bar"]
  );
  proclaim.deepEqual(
    Array.prototype.filter.call([42, 43, 44], stringsOnly),
    []
  );
});
