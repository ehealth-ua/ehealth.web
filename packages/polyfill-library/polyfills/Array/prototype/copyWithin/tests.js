...
it("works with 3 args", function() {
  proclaim.deepStrictEqual([1, 2, 3, 4, 5].copyWithin(0, 3, 4), [
    4,
    2,
    3,
    4,
  ...
  proclaim.deepStrictEqual([1, 2, 3, 4, 5].copyWithin(1, 3, 4), [
    1,
    4,
    3,
    4,
  ...
  proclaim.deepStrictEqual([1, 2, 3, 4, 5].copyWithin(1, 2, 4), [
    1,
    3,
    4,
    4,
...
it("works with negative args", function() {
  ...
  proclaim.deepStrictEqual([1, 2, 3, 4, 5].copyWithin(0, -2, -1), [
    4,
    2,
    3,
    4,
  ...
  proclaim.deepStrictEqual([1, 2, 3, 4, 5].copyWithin(-4, -3, -2), [
    1,
    3,
    3,
    4,
  ...
  proclaim.deepStrictEqual([1, 2, 3, 4, 5].copyWithin(-4, -3, -1), [
    1,
    3,
    4,
    4,
...
var ifSupportsUnscopableSymbol =
  areSymbolsSupported && "unscopables" in this.Symbol ? it : xit;

ifSupportsUnscopableSymbol("is unscopable", function() {
  proclaim.ok(
    "copyWithin" in Array.prototype[Symbol.unscopables],
    "In Array#@@unscopables"
  );
});
