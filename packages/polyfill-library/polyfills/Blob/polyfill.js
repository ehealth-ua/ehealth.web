...
(function(view) {
    ...
    try {
      ...
      BlobBuilder.prototype.append = function append(data /*, endings*/) {
        if (
          ...
          !(get_class(data) === "Blob" || get_class(data) === "File") &&
          !(FakeBlob && data instanceof FakeBlob)
        ) {
          if (typeof data !== "string") {
            data += ""; // convert unsupported types to strings
          }
  ...
  view.Blob = function() {
    ...
    if (isInstanceOfBlob === false) {
      throw new TypeError(
        "Failed to construct 'Blob': Please use the 'new' operator, this DOM object constructor cannot be called as a function."
      );
    }
    ...
    if (typeof options !== "undefined" && typeof options !== "object") {
      throw new TypeError(
        "Failed to construct 'Blob': parameter 2 ('options') is not an object."
      );
    }
    ...
    if (blobParts) {
      for (var i = 0, len = blobParts.length; i < len; i++) {
        if (
          ...
          blobParts[i] instanceof Uint8Array
        ) {
