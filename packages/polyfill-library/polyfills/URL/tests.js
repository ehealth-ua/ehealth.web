...
it("URL Stringifying", function() {
  ...
  proclaim.equal(
    String(new URL("http://example.com:8080")),
...
it("Base URL", function() {
  // fully qualified URL
  proclaim.equal(
    new URL("http://example.com", "https://example.org").href,
    "http://example.com/"
  );
  proclaim.equal(
    new URL("http://example.com/foo/bar", "https://example.org").href,
    "http://example.com/foo/bar"
  );

  // protocol relative
  proclaim.equal(
    new URL("//example.com", "https://example.org").href,
    "https://example.com/"
  );

  // path relative
  proclaim.equal(
    new URL("/foo/bar", "https://example.org").href,
    "https://example.org/foo/bar"
  );
  proclaim.equal(
    new URL("/foo/bar", "https://example.org/baz/bat").href,
    "https://example.org/foo/bar"
  );
  proclaim.equal(
    new URL("./bar", "https://example.org").href,
    "https://example.org/bar"
  );
  proclaim.equal(
    new URL("./bar", "https://example.org/foo/").href,
    "https://example.org/foo/bar"
  );
  proclaim.equal(
    new URL("bar", "https://example.org/foo/").href,
  ...
  proclaim.equal(
    new URL("../../bar", "https://example.org/foo/baz/bat/").href,
    "https://example.org/foo/bar"
  );
  proclaim.equal(
    new URL("../../bar", "https://example.org/foo/baz/bat").href,
  ...
  proclaim.equal(
    new URL("../../bar", "https://example.org/foo/baz/").href,
    "https://example.org/bar"
  );
  proclaim.equal(
    new URL("../../bar", "https://example.org/foo/").href,
  ...
  proclaim.equal(
    new URL("bar?ab#cd", "https://example.org/foo/").href,
    "https://example.org/foo/bar?ab#cd"
  );
  proclaim.equal(
    new URL("bar?ab#cd", "https://example.org/foo").href,
    "https://example.org/bar?ab#cd"
  );
  proclaim.equal(
    new URL("?ab#cd", "https://example.org/foo").href,
    "https://example.org/foo?ab#cd"
  );
  proclaim.equal(
    new URL("?ab", "https://example.org/foo").href,
    "https://example.org/foo?ab"
  );
  proclaim.equal(
    new URL("#cd", "https://example.org/foo").href,
    "https://example.org/foo#cd"
  );
});
