...
var ifSupportsDescriptors =
  Object.defineProperty && arePropertyDescriptorsSupported() ? it : xit;
...
describe("#codePointAt()", function() {
  ...
  ifSupportsDescriptors("is not enumerable", function() {
    proclaim.isFalse(
      Object.prototype.propertyIsEnumerable.call(String.prototype.codePointAt)
    );
  });
  ...
  ifHasStrictModeIt(
    "should throw a TypeError when called on null or undefined",
    function() {
