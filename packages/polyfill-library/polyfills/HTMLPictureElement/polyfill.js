...
!(function(a) {
  ...
  var b,
    c = 0,
    d = function() {
      window.picturefill && a(window.picturefill),
        (window.picturefill || c > 9999) && clearInterval(b),
        c++;
    };
  (b = setInterval(d, 8)), d();
})(function(a) {
  ...
  if (
    ((h.mutationSupport = !1),
    (h.observer = f),
    Object.keys && window.HTMLSourceElement && b.addEventListener)
  ) {
    var i,
      j,
      k,
      l,
      m = { src: 1, srcset: 1, sizes: 1, media: 1 },
      n = Object.keys(m),
      o = { attributes: !0, childList: !0, subtree: !0, attributeFilter: n },
      p = c && c.prototype,
      q = {},
      r = function(a, b) {
        (q[a] = h[a]), (h[a] = b);
    ...
    p &&
      ...
      p &&
        ...
        (h.mutationSupport = !(!Object.create || !Object.defineProperties))),
      h.mutationSupport &&
        ((f.observe = function() {
        ...
        r("setSrc", function() {
          ...
          return (
            f.disconnect(),
            (a = q.setSrc.apply(this, arguments)),
            b && f.observe(),
            a
          );
        }),
        (h.onMutations = function(a) {
          ...
          for (b = 0, c = a.length; c > b; b++)
            g && "childList" === a[b].type
              ? h.onSubtreeChange(a[b], d)
              : "attributes" === a[b].type && h.onAttrChange(a[b], d);
          d.length && h.fillImgs({ elements: d, reevaluate: !0 });
        }),
        (h.onSubtreeChange = function(a, b) {
          h.findAddedMutations(a.addedNodes, b),
            h.findRemovedMutations(a.removedNodes, a.target, b);
        }),
          ...
          for (c = 0, d = a.length; d > c; c++)
            (e = a[c]),
              1 === e.nodeType &&
                ...
                "PICTURE" === f
                  ? h.addToElements(e.getElementsByTagName("img")[0], b)
                  : "IMG" === f && i(e, h.selShort)
                    ? h.addToElements(e, b)
                    : "SOURCE" === f
        ...
        (h.addImgForSource = function(a, b, c) {
          b &&
            "PICTURE" !== (b.nodeName || "").toUpperCase() &&
            ((b = b.parentNode),
            (b && "PICTURE" === (b.nodeName || "").toUpperCase()) ||
              (b = null)),
            b && h.addToElements(b.getElementsByTagName("img")[0], c);
        }),
        (h.addToElements = function(a, b) {
          var c, d;
          if (a)
            if ("length" in a && !a.nodeType)
              for (c = 0, d = a.length; d > c; c++) h.addToElements(a[c], b);
        ...
        (h.onAttrChange = function(a, b) {
          var c,
            d = a.target[h.ns];
          d ||
          "srcset" !== a.attributeName ||
          "IMG" !== (c = a.target.nodeName.toUpperCase())
            ? d &&
              (c || (c = a.target.nodeName.toUpperCase()),
              "IMG" === c
                ? (a.attributeName in d && (d[a.attributeName] = void 0),
        ...
        h.supPicture ||
          (d && !h.testMutationEvents
            ...
            : ((l = (function() {
              ...
              b.documentElement.addEventListener(
                "DOMNodeInserted",
                function(a) {
                  f.connected &&
                    g &&
          ...
          window.HTMLImageElement &&
            ...
            !(function() {
              var a = b.createElement("img"),
                ...
                e = a.setAttribute,
                f = { src: 1 };
              h.supSrcset && !h.supSizes && (f.srcset = 1),
                ...
                h.supSrcset || c.push("srcset"),
                h.supSizes || c.push("sizes"),
                ...
                "currentSrc" in a ||
                  !(function() {
                    var a,
                      c = function(a, b) {
                        null == b && (b = a.src || ""),
                          Object.defineProperty(a, "pfCurrentSrc", {
                            value: b,
                            writable: !0
                          });
                      },
                    ...
                    h.supSrcset &&
                      ...
                      (c = function(b) {
                        ...
                        if (
                          ...
                          i.srcset &&
                          i.sets &&
                          (e = h.parseSet(i.sets[0])) &&
                          e.sort
                        ) {
                          for (
                            e.sort(a), f = e.length, g = e[f - 1], c = 0;
                            f > c;
                            c++
                          )
                      ...
                      b.addEventListener(
                        "load",
                        function(a) {
                          "IMG" === a.target.nodeName.toUpperCase() &&
                            c(a.target);
                        },
                        !0
                      ),
                ...
                !window.HTMLSourceElement ||
                  "srcset" in b.createElement("source") ||
                  ["srcset", "sizes"].forEach(function(a) {
                    Object.defineProperty(
