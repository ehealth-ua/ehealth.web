...
const InviteSignUpForm = ({
  ...
  <form className={styles.main} onSubmit={handleSubmit(onSubmit)}>
    ...
    <div className={classnames(styles.description, styles.description_black)}>
      Зверніть увагу, що приймаючи запрошення, Ви погоджуєтесь на обробку Ваших
      персональних даних з метою забезпечення роботи в Електронній системі
      охорони здоров’я.
    </div>
    <div className={styles.confirm}>
      <Field
        labelText="Даю згоду на обробку моїх персональних даних в Електронній системі охорони здоров’я"
        type="checkbox"
        name="confirm"
