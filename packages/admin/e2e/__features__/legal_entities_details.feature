...
Scenario: Get LEGAL_ENTITY Details (RELATED_LEGAL_ENTITES)
  ...
  And I should see button ADD_NEW_RELATED_LEGAL_ENTITY
...
Scenario: ADD_NEW_RELATED_LEGAL_ENTITY 
  ...
  And I submit form
  Then I see preview with LEGAL_ENTITY_DETAILS and buttton ADD
  And I press button
  ...
  And I return to RELATED_LEGAL_ENTITES tab
