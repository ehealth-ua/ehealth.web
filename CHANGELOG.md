...
* **admin:** reset state when user load new file ([972224a](https://github.com/edenlabllc/ehealth.web/commit/972224a))
...
<a name="1.118.5"></a>
## [1.118.5](https://github.com/edenlabllc/ehealth.web/compare/v1.118.4...v1.118.5) (2019-06-25)
...
<a name="1.118.2"></a>
## [1.118.2](https://github.com/edenlabllc/ehealth.web/compare/v1.118.1...v1.118.2) (2019-06-24)
...
* **admin:** add UpdateDescription popup for ProgramServices details ([455284f](https://github.com/edenlabllc/ehealth.web/commit/455284f))
...
* **gatekeeper:** ability to set auth cookie on multiple domains ([#986](https://github.com/edenlabllc/ehealth.web/issues/986)) ([6a4fe9b](https://github.com/edenlabllc/ehealth.web/commit/6a4fe9b))
...
* update issue template [skip ci] ([1038a71](https://github.com/edenlabllc/ehealth.web/commit/1038a71))
...
* **admin:** actualize employee types for contracts ([fe38bc9](https://github.com/edenlabllc/ehealth.web/commit/fe38bc9))
...
* "refactor(mock-server): remove schema.json from remote" ([3f5c45c](https://github.com/edenlabllc/ehealth.web/commit/3f5c45c))
...
* add github action to rebase pull requests [skip ci] ([#879](https://github.com/edenlabllc/ehealth.web/issues/879)) ([d2af76d](https://github.com/edenlabllc/ehealth.web/commit/d2af76d))
...
<a name="1.72.0"></a>
# [1.72.0](https://github.com/edenlabllc/ehealth.web/compare/v1.71.1...v1.72.0) (2019-03-26)


### Features

* **mock-server:** update schema to 2.26.0 ([c2b9ef4](https://github.com/edenlabllc/ehealth.web/commit/c2b9ef4))
...
* **mock-server:** update schema ([61dd74f](https://github.com/edenlabllc/ehealth.web/commit/61dd74f))
...
* **mock-server:** update schema and `[@ehealth-ua](https://github.com/ehealth-ua)/schema` version ([1ad67f9](https://github.com/edenlabllc/ehealth.web/commit/1ad67f9))
...
<a name="1.41.0"></a>
# [1.41.0](https://github.com/edenlabllc/ehealth.web/compare/v1.40.4...v1.41.0) (2019-02-08)


### Features

* **mock-server:** update schema to 2.10.6 ([29c8400](https://github.com/edenlabllc/ehealth.web/commit/29c8400))
...
* **components:** import macro for styled component ([9c69490](https://github.com/edenlabllc/ehealth.web/commit/9c69490))
...
* **gatekeeper:** change endpoint ([cd46406](https://github.com/edenlabllc/ehealth.web/commit/cd46406))
...
* **admin:** update schema.json ([477b66c](https://github.com/edenlabllc/ehealth.web/commit/477b66c))
...
* **admin:** add match-sorter package ([25f0a62](https://github.com/edenlabllc/ehealth.web/commit/25f0a62))
...
* **components:** increase padding in Popup ([f140214](https://github.com/edenlabllc/ehealth.web/commit/f140214))
...
* update package-lock.json ([b03f807](https://github.com/edenlabllc/ehealth.web/commit/b03f807))
...
* **mock-server:** fix import ([be605a6](https://github.com/edenlabllc/ehealth.web/commit/be605a6))


### Features

* **admin:** add async jobs feature definitions ([0331e91](https://github.com/edenlabllc/ehealth.web/commit/0331e91))
* **mock-server:** add divisions to LegalEntity type ([34ebbe7](https://github.com/edenlabllc/ehealth.web/commit/34ebbe7))
...
* rebuild package-lock.json ([cfc60af](https://github.com/edenlabllc/ehealth.web/commit/cfc60af))
...
* add proper decrarations for Object.values and Objest.entries ([2692ab1](https://github.com/edenlabllc/ehealth.web/commit/2692ab1))
...
* **components:** annotate Field component, add field state to render prop metadata ([8f2eb6d](https://github.com/edenlabllc/ehealth.web/commit/8f2eb6d))
...
* **patient-account:** change config ([d0be725](https://github.com/edenlabllc/ehealth.web/commit/d0be725))
...
* **icons:** add ChevronBottomIcon ([5562a1d](https://github.com/edenlabllc/ehealth.web/commit/5562a1d))
...
* **components:** parse unknown error in component FormError ([86efa55](https://github.com/edenlabllc/ehealth.web/commit/86efa55))
...
- **components:** increase leaveTimeout value for Tooltip hidding ([#199](https://github.com/edenlabllc/ehealth.web/issues/199)) ([1974ad2](https://github.com/edenlabllc/ehealth.web/commit/1974ad2))
...
- **icons:** rename spinner icon ([0dc829c](https://github.com/edenlabllc/ehealth.web/commit/0dc829c))
- **patient-account:** change conditions in query ([0683ef8](https://github.com/edenlabllc/ehealth.web/commit/0683ef8))

### Features

- **icons:** add spinner icon ([fc54d8a](https://github.com/edenlabllc/ehealth.web/commit/fc54d8a))
...
- **utils:** add comments ([9973d68](https://github.com/edenlabllc/ehealth.web/commit/9973d68))
...
- remove http package links from package-lock.json ([0e48766](https://github.com/edenlabllc/ehealth.web/commit/0e48766))
...
- **components:** add size prop for button in SelectField component ([9501fbe](https://github.com/edenlabllc/ehealth.web/commit/9501fbe))
- **components:** change props from getBoundingClientRect result for IE11 ([3b650c5](https://github.com/edenlabllc/ehealth.web/commit/3b650c5))
...
- **utils:** fix format date ([638808e](https://github.com/edenlabllc/ehealth.web/commit/638808e))
...
- **gatekeeper:** change settings for clear cookies in Logout ([45056b1](https://github.com/edenlabllc/ehealth.web/commit/45056b1))
...
- **components:** add disabled prop on dropdown button in Select component ([cd7f167](https://github.com/edenlabllc/ehealth.web/commit/cd7f167))
...
- **components:** change color of disabled input ([f0c0538](https://github.com/edenlabllc/ehealth.web/commit/f0c0538))
...
- **gatekeeper:** add endpoint logout ([625d948](https://github.com/edenlabllc/ehealth.web/commit/625d948))
...
- **utils:** use dots instead of slashes as separator when formatting dates ([927c8e8](https://github.com/edenlabllc/ehealth.web/commit/927c8e8))
...
- **components:** change date validation to pass when value is empty ([d76ff14](https://github.com/edenlabllc/ehealth.web/commit/d76ff14))
...
- add missing dependencies to package-lock.json ([84c694a](https://github.com/edenlabllc/ehealth.web/commit/84c694a))
...
- **icons:** add CloseIcon ([13d96b5](https://github.com/edenlabllc/ehealth.web/commit/13d96b5))
...
- **components:** Fix multiline bug in FileField ([1ff0230](https://github.com/edenlabllc/ehealth.web/commit/1ff0230))
- **patient-account:** Add setSearchParams in FormAutoFetch ([ddbab8f](https://github.com/edenlabllc/ehealth.web/commit/ddbab8f))
...
- **postmessage-client:** bootstrap package ([0f72a62](https://github.com/edenlabllc/ehealth.web/commit/0f72a62))
- **react-iit-digital-signature:** refactor package, add Signer component ([3d3ac26](https://github.com/edenlabllc/ehealth.web/commit/3d3ac26))
...
- **components:** add Tooltip component ([8736fed](https://github.com/edenlabllc/ehealth.web/commit/8736fed))
